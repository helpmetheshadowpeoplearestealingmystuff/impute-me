...
export_function<-function(uniqueID){
  ...
  output[["documentation"]][["source"]] <- "https://github.com/lassefolkersen/impute-me/blob/31846520f7bb84c3ab079b5fd0ea202bbf30b844/precisionMedicine/SNPs_to_analyze.txt"
