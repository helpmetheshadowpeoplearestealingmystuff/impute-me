#just a temporary file for testing stuff locally
...
prepare_23andme_genome<-function(path, email, filename){
	...
	if(uniqueID%in%list.files("C:/Users/FOLK/Documents/Work/Bioinformatics/data/")){
	...
	dir.create(paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data/",uniqueID,sep=""))
	...
	otherPersons<-list.files("C:/Users/FOLK/Documents/Work/Bioinformatics/data",full.names=T)
	for(otherPerson in otherPersons){
		...
		if(this_person_md5sum == other_person_md5sum){
			...
			m<-paste(m,collapse="\t")
			write(m,file="/home/ubuntu/misc_files/submission_log.txt",append=TRUE)			
			unlink(paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data/",uniqueID,sep=""),recursive=T)
...
get_genotypes<-function(
	...
	if(class(uniqueID)!="character")stop(paste("uniqueID must be character, not",class(uniqueID)))
	if(length(uniqueID)!=1)stop(paste("uniqueID must be lengh 1, not",length(uniqueID)))
	idFolder<-paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data",uniqueID,sep="/")
	...
	idTempFolder<-paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data",uniqueID,"temp",sep="/")
...
crawl_for_snps_to_analyze<-function(uniqueIDs=NULL){
	...
	if(is.null(uniqueIDs)){
		uniqueIDs<-list.files("C:/Users/FOLK/Documents/Work/Bioinformatics/data/")
	}else{
		if(class(uniqueIDs)!="character")stop("UniqueIDs must be of class character")
		if(!all(file.exists(paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data/",uniqueIDs,sep=""))))stop("Not all UniqueIDs given were found")
	}
	...
	for(uniqueID in uniqueIDs){
		...
		if(class(genotypes)=="try-error"){
			if(file.exists(paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data/",uniqueID,"/temp",sep=""))){
				next
			}else{
...
remove_snps_from_cache<-function(snps,verbose=T){
	...
	for(uniqueID in uniqueIDs){
		cacheFile<-paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data/",uniqueID,"/",uniqueID,".cached.gz",sep="")
...
remove_all_temp_folders<-function(uniqueIDs=NULL){
	...
	for(uniqueID in uniqueIDs){
		tempFolder<-paste("C:/Users/FOLK/Documents/Work/Bioinformatics/data/",uniqueID,"/temp",sep="")
