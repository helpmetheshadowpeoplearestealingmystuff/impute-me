...
shinyUI(bootstrapPage(
	...
	beginPage(),	
	beginPanel('1/3'),
	HTML("Appearance traits, such as height and hair colour are highly heritable and your genome can provide clues to what they are. Of course the ultimate information-source for this is a mirror, but nonetheless it can be  interesting to perform the analysis on e.g. children to provide estimates of their final height and apperance. Additional work is in progress on other traits such as eye and skin colour and even facial form. However, the fact is that these traits are much harder to predict and therefore a genetic analysis provides more limited benefit. Therefore this module focuses on height, which is highly heritable, and hair-colour which currently is a bit more guess-work. To run analysis input your user-id, or use the test-value of id_57n662948$."<br><br>),
