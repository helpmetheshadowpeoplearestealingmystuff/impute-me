...
shinyServer(function(input, output) {
    ...
    #setting up back-ground frequency sources
		...
		if(ethnicity_group == "global"){
		  ...
		  densityCurvePath<-"/home/ubuntu/srv/impute-me/AllDiseases/2018-07-26_densities_ALL.rdata"
		}else{
		  ...
		  densityCurvePath<-paste0("/home/ubuntu/srv/impute-me/AllDiseases/2018-07-26_densities_",ethnicity_group,".rdata")
		}
